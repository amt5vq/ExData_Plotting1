...
plot(as.POSIXct(paste(filtered$Date,filtered$Time),format="%d/%m/%Y %H:%M:%S"), filtered$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")

plot(as.POSIXct(paste(filtered$Date,filtered$Time),format="%d/%m/%Y %H:%M:%S"), filtered$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(as.POSIXct(paste(filtered$Date,filtered$Time),format="%d/%m/%Y %H:%M:%S"), filtered$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
